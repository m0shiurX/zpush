            ...
            <div class="rounded-lg border border-white bg-white/50 p-6 shadow-sm shadow-surface-alt">
                <form @submit.prevent="submit">
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <!-- Email -->
                        <div>
                            <label for="email" class="mb-1 block text-sm font-medium text-text-muted">
                        ...
                        <!-- Password -->
                        <div>
                            <label for="password" class="mb-1 block text-sm font-medium text-text-muted">
                        ...
                        <!-- Confirm Password -->
                        <div>
                            <label for="password_confirmation" class="mb-1 block text-sm font-medium text-text-muted">
                                Confirm Password
                        ...
                        <!-- Status -->
                        <div>
                            <label for="status" class="mb-1 block text-sm font-medium text-text-muted">
                                Status
                            </label>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="max-h-48 overflow-y-auto rounded-lg border border-border bg-white p-4">
                            ...
                            <p v-if="roles.length === 0" class="text-sm text-text-muted">
                                No roles available
                            </p>
                        </div>
                        <p v-if="form.errors.roles" class="mt-1 text-sm text-danger">
                            {{ form.errors.roles }}
                        </p>
                    </div>
                    ...
                    <div class="mt-6 flex items-center gap-4 border-t border-border pt-6">
                        ...
                        <Link href="/settings/users" class="text-text-muted hover:text-text">
                            Cancel
                        </Link>
                    </div>
                </form>
